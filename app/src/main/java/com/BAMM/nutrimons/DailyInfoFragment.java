...
public class DailyInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        */
        ...
        List<com.BAMM.nutrimons.database.Meal> finalBreakfast = breakfast;
        List<com.BAMM.nutrimons.database.Meal> finalLunch = lunch;
        List<com.BAMM.nutrimons.database.Meal> finalDinner = dinner;
        List<com.BAMM.nutrimons.database.Meal> finalSnack = snack;
        ...
        removeMealButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRows.size() > 0) {
                    ...
                    final com.BAMM.nutrimons.database.DateData dateData =
                            new com.BAMM.nutrimons.database.DateData(finalCurrentDay,
