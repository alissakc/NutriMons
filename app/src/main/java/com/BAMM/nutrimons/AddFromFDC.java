...
public class AddFromFDC extends Fragment {
    ...
    {
        public com.BAMM.nutrimons.database.Meal food;
        public Button selectButton, detailsButton;
        public boolean isDetailsOpen;
        public TextView text;

        public foodRow(com.BAMM.nutrimons.database.Meal food, Button selectButton, Button detailsButton, TextView text)
        {
            this.food = food;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i = 0; i < foodArray.length(); ++i)
                            {
                                ...
                                com.BAMM.nutrimons.database.Meal food = new com.BAMM.nutrimons.database.Meal();
